...
## 主流代码对接示例
### 1) cURL（REST 历史 K 线）
<pre><code>curl -X GET "https://kun.pro/api/history?market=KR&symbol=KRX:000040&interval=1&count=200" \
  -H "Authorization: Bearer YOUR_TOKEN" \
  -H "Accept: application/json"</code></pre>

### 2) JavaScript（fetch）
<pre><code>const url = "https://kun.pro/api/history?market=KR&symbol=KRX:000040&interval=1&count=200";
...
url = "https://kun.pro/api/history?market=KR&symbol=KRX:000040&interval=1&count=200"
headers = {
    "Authorization": "Bearer YOUR_TOKEN",
    "Accept": "application/json"
}
...
public class Main {
  public static void main(String[] args) throws Exception {
    String url = "https://kun.pro/api/history?market=KR&symbol=KRX:000040&interval=1&count=200";
...
class Program {
  static async Task Main() {
    var url = "https://kun.pro/api/history?market=KR&symbol=KRX:000040&interval=1&count=200";
